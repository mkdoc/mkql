...
function entry(match, parent) {
  ...
  if(o.rest && ~o.rest.indexOf('[]')) {
    throw new Error('bad attribute declaration: ' + o.rest);
  }

  if(o.attrs && o.type && noattrs[o.type]) {
    throw new Error('type ' + o.tag + ' does not support attribute selectors');
  }
